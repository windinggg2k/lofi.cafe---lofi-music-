    ...
    82: function(e, t, n) {
        ...
        var x = function() {
          ...
          , g = [{
            ...
            id: "FjHGZj2IjBk",
            name: "[Bình yên thư giãn nhẹ nhàng] Thiền - Monoman"
        }]
          , y = {
            track: function(e, t) {}
        }
        ...
        var Ye = n.p + "static/media/boot.47b60944.mp3"
          ...
          , Xe = new (n.n(Fe).a)({
            en: {
                ...
                changeStation: "chuyển bài",
                playPause: "play/pause",
                changeGif: "thay đổi nền",
                showVideo: "thay đổi khung hình",
                lowPowerMode: "làm nhiễu",
                closeThis: "thoát toàn màn hình",
                sayHi: "Hoặc bấm vào đây để gửi lời chào!",
                updates: "Nhận thông báo & updates",
                arrows: "trái phải <  >",
                spacebar: "spacebar"
            },
            ja: {
